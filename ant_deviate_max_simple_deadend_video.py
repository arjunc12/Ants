...
def deviate(G,num_iters, num_ants, pheromone_add, pheromone_decay, explore_prob, max_steps, \
    ...
    for iter in xrange(num_iters):
        ...
        if print_graph:        
            color_graph(G, 'g', (pheromone_add / max_weight), "graph_after_max_simple_deadend%d_e%0.2fd%0.2f" % (max_steps, explore_prob, pheromone_decay))
            print "graph colored"
        ...
        if video:    
            ...
            ani.save("ant_deviate_max_simple_deadend" + str(iter) + ".mp4")
        ...
        if video2:    
            ...
            ani.save("ant_deviate_max_simple_deadend" + str(iter) + "a.mp4")
