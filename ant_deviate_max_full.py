...
def deviate(G,num_iters, num_ants, pheromone_add, pheromone_decay, print_path=False, print_graph=False, video=False, nframes=200, explore_prob=0.1, max_steps=3000):
    ...
    data_file = open('ant_deviate_max_full%d.csv' % max_steps, 'a')
...
#                 before_paths = max(before_paths, pheromone_connectivity(G2, nest, target))
        ...
        if print_graph:        
            color_graph(G, 'g', (pheromone_add / max_weight), "graph_after_max_full%d_e%0.2fd%0.2f" % (max_steps, explore_prob, pheromone_decay))
            print "graph colored"
        ...
        if video:    
            ...
            ani.save("ant_deviate_max_full" + str(iter) + ".mp4")
        ...
        if video:    
            ...
            ani.save("ant_deviate_max_full" + str(iter) + "a.mp4")
