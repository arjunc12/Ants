...
def deviate(G, num_iters, num_ants, pheromone_add, pheromone_decay, explore_prob, \
    ...
    data_file = open('ant_deviate_1way_full%d.csv' % max_steps, 'a')
    pruning_file = open('ant_deviate_1way_full_pruning%d.csv' % max_steps, 'a')
    ...
    for iter in xrange(num_iters):
        ...
        if cost_plot:
            figname = "pruning/pruning_1way_full%d_e%0.2fd%0.2f" % (max_steps, explore_prob, pheromone_decay)
